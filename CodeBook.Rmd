...
This dataset contains the average of each selected measurement (mean and standard deviation) for each activity and each subject. It includes 180 rows (30 subjects × 6 activities) and 68 variables.

Each variable represents a mean value of a sensor signal, grouped by subject and activity. The dataset was created using base R functions and follows tidy data principles.
